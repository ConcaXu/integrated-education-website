const translations = {
    'zh-CN': {
        ...
        // Hero
        'hero_title': '您旅行的终极指南',
        'hero_subtitle': '多语言服务 | 144小时免签 | AI智能工具 | 全方位行程规划',
        'search_dest_label': '目的地',
        'search_dest_ph': '请输入目的地',
        'search_btn': '搜索',
        
        // Policy
        'policy_title': '关于144小时过境免签政策',
        'policy_desc': '国务院批准在上海市、江苏省、浙江省、辽宁省等地实施144小时过境免签政策。54个国家的旅客凭有效国际旅行证件和144小时内确定日期、座位前往第三国（地区）的联程客票，可选择从相关口岸入境或出境，免办签证。',
        'stat_1_val': '54国',
        'stat_1_label': '适用国家',
        'stat_2_val': '144h',
        'stat_2_label': '免签时长',
        ...
        // Guides
        'guides_title': '漫游指南',
        'guide_1_title': '中国早餐全指南',
        'guide_1_desc': '从豆浆油条到广东早茶，开启美味的一天。',
        'guide_2_title': '中国传统节日',
        'guide_2_desc': '了解春节、中秋节等重要节日的习俗。',
        'guide_3_title': '长城游览攻略',
        'guide_3_desc': '如何避开人群，拍摄最美的长城照片。',
        'guide_4_title': '中国高铁指南',
        'guide_4_desc': '如何购买车票，体验中国速度。',
        'guide_5_title': '移动支付教程',
        'guide_5_desc': '像本地人一样使用微信和支付宝。',
        'guide_6_title': '特色伴手礼',
        'guide_6_desc': '值得带回家的中国特色礼物推荐。',
        
        // FAQ
        'faq_title': '常见问题',
        'faq_subtitle': '我们为您解答旅行中的疑惑',
        'faq_q1': '1. 什么是144小时过境免签政策？',
        'faq_a1': '144小时过境免签政策允许来自54个国家的旅客，持有有效国际旅行证件和144小时内确定日期及座位的联程客票，在指定的中国口岸入境，并在规定区域内停留不超过144小时，无需申请签证。',
        'faq_q2': '2. 我可以使用移动支付吗？',
        'faq_a2': '是的，您可以下载支付宝或微信App，并绑定您的国际信用卡。现在这些应用都支持国际卡直接支付，非常方便。',
        'faq_q3': '3. 中国的插座标准是什么？',
        'faq_a3': '中国使用220V电压。插座通常为两孔（A型/C型）或三孔（I型）。建议携带通用转换插头。',
        'faq_q4': '4. 可以在中国使用社交媒体吗？',
        'faq_a4': '中国有自己的社交媒体生态，如微信、微博、小红书等。部分国际社交媒体可能需要使用漫游服务才能访问。',
        'faq_q5': '5. 需要给小费吗？',
        'faq_a5': '中国通常没有给小费的习惯。餐厅、出租车等服务行业不强制收取小费。',
    ...
    'en': {
        ...
        'hero_subtitle': 'Multi-language Service | 144h Visa-Free | AI Tools | Comprehensive Planning',
        'search_dest_label': 'Destination',
        'search_dest_ph': 'Where to go?',
        'search_btn': 'Search',
        
        // Policy
        'policy_title': 'About 144-Hour Transit Visa-Free Policy',
        'policy_desc': 'Approved by the State Council, the 144-hour visa-free transit policy is implemented in Shanghai, Jiangsu, Zhejiang, Liaoning, and other places. Travelers from 54 countries with valid international travel documents and connecting tickets to a third country (region) within 144 hours can choose to enter or exit from relevant ports without a visa.',
        'stat_1_val': '54 Countries',
        'stat_1_label': 'Eligible Countries',
        'stat_2_val': '144h',
        'stat_2_label': 'Visa-Free Duration',
        'stat_3_val': '24 Ports',
        'stat_3_label': 'Open Ports',
        'stat_4_val': '60+',
        'stat_4_label': 'Easy Entry',
        
        // Cities
        'cities_title': 'Popular Chinese Cities',
        'view_more': 'View More',
        'city_1': 'Haikou',
        'city_2': 'Fuzhou',
        'city_3': 'Harbin',
        ...
        // Guides
        'guides_title': 'Travel Guides',
        'guide_1_title': 'Complete Guide to Chinese Breakfast',
        'guide_1_desc': 'From soy milk and fritters to Cantonese morning tea, start a delicious day.',
        'guide_2_title': 'Traditional Chinese Festivals',
        'guide_2_desc': 'Learn about customs of Spring Festival, Mid-Autumn Festival, etc.',
        'guide_3_title': 'Great Wall Tour Guide',
        'guide_3_desc': 'How to avoid crowds and take the best photos.',
        'guide_4_title': 'China High-Speed Rail Guide',
        'guide_4_desc': 'How to buy tickets and experience China speed.',
        'guide_5_title': 'Mobile Payment Tutorial',
        'guide_5_desc': 'Use WeChat and Alipay like a local.',
        'guide_6_title': 'Special Souvenirs',
        'guide_6_desc': 'Recommended gifts worth taking home.',
        
        // FAQ
        'faq_title': 'FAQ',
        'faq_subtitle': 'We answer your travel questions',
        'faq_q1': '1. What is the 144-hour visa-free transit policy?',
        'faq_a1': 'The 144-hour visa-free transit policy allows travelers from 54 countries with valid international travel documents and connecting tickets with confirmed dates and seats within 144 hours to enter via designated Chinese ports and stay within specified areas for up to 144 hours without applying for a visa.',
        'faq_q2': '2. Can I use mobile payment?',
        'faq_a2': 'Yes, you can download Alipay or WeChat App and bind your international credit card. These apps now support direct payment with international cards, which is very convenient.',
        'faq_q3': '3. What is the power plug standard in China?',
        'faq_a3': 'China uses 220V voltage. Sockets are usually two-hole (Type A/C) or three-hole (Type I). It is recommended to bring a universal adapter.',
        'faq_q4': '4. Can I use social media in China?',
        'faq_a4': 'China has its own social media ecosystem, such as WeChat, Weibo, Xiaohongshu, etc. Some international social media may require roaming services to access.',
        'faq_q5': '5. Do I need to tip?',
        'faq_a5': 'Tipping is generally not customary in China. Restaurants, taxis, and other service industries do not require mandatory tipping.',
        
        // Footer
        'footer_about': 'About',
        'footer_intro': 'Introduction',
        'footer_culture': 'Culture',
        'footer_team': 'Team',
        'footer_service': 'Service',
        'footer_tourism': 'Tourism',
        'footer_hotel': 'Hotel',
...
$(document).ready(function() {
    ...
    $('#lang-switch-btn').click(function(e) {
        ...
        if (currentLang === 'zh-CN') {
            currentLang = 'en';
            $(this).find('.current-lang-text').text('EN English');
        } else {
            currentLang = 'zh-CN';
            $(this).find('.current-lang-text').text('CN 简体中文');
        }
