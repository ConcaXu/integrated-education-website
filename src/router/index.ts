...
const routes = [
  ...
  { path: '/singapore-explorers-junior-high', name: 'SingaporeExplorersJuniorHigh', component: () => import('@/views/SingaporeExplorersJuniorHighView.vue'), meta: { titleZh: '新加坡未来探索系列 初中课程', titleEn: 'Singapore Future Explorers Junior High' } },
  { path: '/china-industry-study-programmes', name: 'ChinaIndustryStudyProgrammes', component: () => import('@/views/ChinaIndustryStudyProgrammesView.vue'), meta: { titleZh: '中国产业考察项目', titleEn: 'China Industry Study Programmes' } },
